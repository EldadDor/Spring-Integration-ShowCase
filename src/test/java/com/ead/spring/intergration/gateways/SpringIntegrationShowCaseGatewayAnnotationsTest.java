...
import com.ead.spring.intergration.gateway.GatewayConfiguration;
import com.ead.spring.intergration.gateway.SimpleGateway;
import com.ead.spring.intergration.gateway.SimpleMarkedGateway;
...
//@ContextConfiguration(loader = DelegatingSmartContextLoader.class, locations = "/spring/integration/gateways/showcase-context-simpleAnnotatedGateway.xml")
@ContextConfiguration(loader = DelegatingSmartContextLoader.class, classes = GatewayConfiguration.class)
public class SpringIntegrationShowCaseGatewayAnnotationsTest {
	...
	public void testFileFetch() throws Exception {
		...
		gateway.somethingSimpleWithReply((SimpleRequest) starting);
